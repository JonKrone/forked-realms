/**
 * This Supabase Function is NOT specific to Forked Realms. It's actually keeping all of my Supabase
 * projects from pausing.
 */
...
async function runKeepAliveQuery(projectRef: string) {
  const runQueryUrl = `https://api.supabase.com/v1/projects/${projectRef}/database/query`
